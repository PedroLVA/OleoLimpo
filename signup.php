                ...
                <div class="col-md-5 col-xl-4 text-center text-md-start">
                    ...
                    <form method="post" data-bs-theme="light">
                        <div class="alinhar">
                            ...
                            <div class="idade mb-3"><input class="shadow-sm form-control" type="text" name="idade" placeholder="idade"></div>
                            ...
                            <div class="numero-rua mb-3"><input class=" shadow-sm form-control" type="text" name="numero" placeholder="Numero rua"></div>
                        ...
                        <div class="mb-5">
                            <button class="btn btn-primary shadow" type="submit" style="background: rgb(1,113,61);">Criar Conta</button>
                        </div>
                    </form>
