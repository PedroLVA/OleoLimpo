    ...
    <div class="container py-4 py-lg-5">
        <div class="row row-cols-2 row-cols-md-4">
            <div class="col-12 col-md-3">
                <div class="fw-bold d-flex align-items-center mb-2"><img src="assets/img/LOGO-OLEO-LIMPO.png" width="144" height="31"></div>
                <p class="text-muted">Evite desperdícios de óleo, recicle conscientemente.</p>
                <a class="nav-link" href="contacts.php" style="color: #121643;">Contato</a>
            </div>
        </div>
        <hr>
